...
static int veryLowSpeed = 150;
static int lowSpeed = 90;
static int normalSpeed = 125;
...
void loop()
{
  ...
  motorDrive(motor1, turnCW, veryLowSpeed);
  ...
  motorDrive(motor1, turnCCW, veryLowSpeed);
  Serial.println("low speed reverse");
  delay(5000);
